module sim_cmos#(
	...
	,	parameter IMG_HDISP = 1500
	,	parameter IMG_VDISP = 1500
)(
		input			clk
	, 	input			rst_n
...
integer iBmpSize;                   //输入BMP 字节�??
integer iDataStartIndex;            //输入BMP 像素数据偏移�??

localparam BMP_SIZE   = 54 + IMG_HDISP * IMG_VDISP * 3 - 1;     //输出BMP 字节�??
...
initial begin
	...
	//根据BMP图片文件头的格式，分别计算出图片�?? 宽度 /高度 /像素数据偏移�?? /图片字节�??
...
//---------------------------------------------
//模拟 OV7725/OV5640 驱动模块输出的时钟使�??
assign    cmos_clken_r  = ~clk;
/*
